...
<?php include('navfixed.php');?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 25px 'Aleo'; color:#0489bd;"><center>Food Processing Industry Ltd, Medina</center></font>
<div id="mainmain">
	<?php
...
<a href="inventory.php"><i class="icon-shopping-cart icon-2x"></i><br> Inventory</a>     
