...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			Total Number of Inventory:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
...
<a rel="facebox" href="addinventory.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:45px;" /><i class="icon-plus-sign icon-large"></i> Add Products within Inventory</button></a><br><br>
